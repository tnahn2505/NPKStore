    ...
    <div class="bg-light rounded p-4">
        ...
        <form class="bg-light p-4 rounded shadow-sm">
            <div class="mb-3 text-center">
                <img src="../upload/<?= htmlspecialchars($user['image']) ?>" 
                     alt="Ảnh đại diện" 
                     class="img-thumbnail" 
            ...
            <div class="text-center">
                <a href="index.php?quanli=danh-sach-khach-hang" class="btn btn-secondary">Quay lại</a>
            </div>
        </form>
    </div>
</div>
...
<style>
    ...
    .form-control[readonly] {
        background-color: #f8f9fa; /* Màu nền nhạt để thể hiện readonly */
        cursor: not-allowed;
    }
</style>
